          ...
          <div className="left">
            ...
            <div className="item">
              ...
              <div className="details">
                <h1 className="titleName">Vinayak Anil</h1>
                <div className="detailItem">
                  <span className="itemKey">Email:</span>
                  <span className="itemValue"> viniwins1177@gmail.com</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Phone:</span>
                  <span className="itemValue"> 7388446511</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Address:</span>
                  <span className="itemValue"> Thane, Mumbai</span>
                </div>
                <div className="detailItem">
